  ...
  const handleSubmit = async (e: FormEvent) => {
    try {
      ...
      if (response.data.success == true) {
        toast(message, {
          containerId: `toastDropJadwal-${myProp.schedule.id}`,
          type: "success",
        });
        setShow(false);
        // reload page
      ...
      <Modal isShow={show}>
        ...
        <form onSubmit={(e) => handleSubmit(e)}>
          <div className="w-full p-3 rounded-t-lg">
            ...
            <h1 className="font-bold text-lg">Delete Jadwal Kereta</h1>
          ...
          {/* modal body */}
          <div className="w-full p-3">Are you sure to remove this data?</div>
