      ...
      const handleSubmit = async (e: FormEvent) => {
            try {
              ...
              if (response.data.success == true) {
                toast(message, {
                  containerId: `toastDropPelanggan-${myProp.pelanggan.id}`,
                  type: "success",
                });
                setShow(false);
                // reload page
          ...
          return (
            <div>
              <ToastContainer containerId={`toastDropPelanggan-${myProp.pelanggan.id}`} />
              <button
                type="button"
              ...
              <Modal isShow={show}>
                ...
                <form onSubmit={(e) => handleSubmit(e)}>
                  <div className="w-full p-3 rounded-t-lg">
                    ...
                    <h1 className="font-bold text-lg">Delete Data Pelanggan</h1>
                    <span className="text-sm text-slate-400">
                      Pastikan data benar benar ingin dihapus?
                    </span>
                  </div>
