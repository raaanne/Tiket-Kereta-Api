...
const ResetPelangganPassword = (myProp: props) => {
  ...
  const handleSubmit = async (e: FormEvent) => {
      try {
        ...
        if (response.data.success == true) {
          toast(message, {
            containerId: `toastEditPelangganPassword-${myProp.pelanggan.id}`,
            type: "success",
          });
          setShow(false);
          // reload page
          ...
          <Modal isShow={show}>
            ...
            <form onSubmit={(e) => handleSubmit(e)}>
              <div className="w-full p-3 rounded-t-lg">
                ...
                <h1 className="font-bold text-lg">Reset Password Pelanggan</h1>
...
export default ResetPelangganPassword;
