  ...
  const handleSubmit = async (e: FormEvent) => {
      try {
        ...
        if (response.data.success == true) {
          toast(message, {
            containerId: `toastDropAdmin-${myProp.admin.id}`,
            type: "success",
          });
          setShow(false);
          // reload page
    ...
    return (
        <div>
          <ToastContainer containerId={`toastDropAdmin-${myProp.admin.id}`} />
          <button
            type="button"
          ...
          <Modal isShow={show}>
            ...
            <form onSubmit={(e) => handleSubmit(e)}>
              <div className="w-full p-3 rounded-t-lg">
                ...
                <h1 className="font-bold text-lg">Delete Data Karyawan</h1>
